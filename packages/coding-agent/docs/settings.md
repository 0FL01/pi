...
| `compaction.cacheFriendly` | boolean | `false` | For OpenAI-compatible local providers, summarize from the current request prefix when it fits; otherwise use standalone summarization |
